        ...
        <form method="POST" action="payment_gateway.php">
            ...
            <?php if ($row['method'] === 'm_pesa'): ?>
                <div class="form-group">
                    ...
                    <input type="tel" name="mpesa_phone" placeholder="0712345678" required maxlength="10" inputmode="numeric" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'')"/>
                </div>
                <div class="form-group">
                    <label>Enter M-Pesa PIN</label>
                    <input type="password" name="mpesa_pin" placeholder="••••" required maxlength="4" inputmode="numeric" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'')"/>
                </div>
            <?php elseif ($row['method'] === 'credit_card'): ?>
                <div class="form-group">
                    <label>Card Number</label>
                    <input type="text" name="card_number" placeholder="4242 4242 4242 4242" required maxlength="19" inputmode="numeric" oninput="this.value=this.value.replace(/[^0-9 ]/g,'')"/>
                </div>
                <div class="form-row">
                    <div class="form-group"><label>Expiry (MM/YY)</label><input type="text" name="card_expiry" placeholder="09/28" required maxlength="5" inputmode="numeric" oninput="this.value=this.value.replace(/[^0-9\/]/g,'')"/></div>
                    <div class="form-group"><label>CVV</label><input type="password" name="card_cvv" placeholder="123" required maxlength="4" inputmode="numeric" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'')"/></div>
                </div>
            <?php else: ?>

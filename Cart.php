...
function isImagePath($str) {
    ...
    return $hasExtension || strpos($str, '/') !== false || strpos($str, '\\') !== false || strpos($str, 'uploads') !== false;
}
?>
...
<head>
    ...
    <title>Shopping Cart - BabyBliss</title>
...
<div class="cart-container">
                    ...
                    <?php foreach($_SESSION['cart'] as $index => $item): ?>
                        <div class="cart-item">
                            <div class="item-image">
                                ...
                                $img = $item['image'];
                                if (isImagePath($img)) {
                                    // Ni file path - onyesha kama image
                                    $imgPath = $img;
                                    ...
                                    echo '<img src="' . htmlspecialchars($imgPath) . '" alt="' . htmlspecialchars($item['name']) . '">';
                                } else {
                                    // Ni emoji
                                    echo $img;
                                }
    ...
    <div class="cart-summary">
        ...
        <!-- ✅ CHECKOUT BUTTON SASA INAFANYA KAZI -->

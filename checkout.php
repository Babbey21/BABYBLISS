...
if (isset($_POST['place_order'])) {
    ...
    if (empty($first_name) || empty($last_name) || empty($email) || empty($street) || empty($city) || empty($country)) {
        ...
        // Save address
        $address_sql = "INSERT INTO addresses (user_id, label, street, city, country, postal_code, is_default) 
                        VALUES ($user_id, 'Order Address', '$street', '$city', '$country', '$postal_code', 0)";
        mysqli_query($conn, $address_sql);
        $address_id = mysqli_insert_id($conn);

        // Save order
        $order_sql = "INSERT INTO orders (user_id, address_id, status, total_amount, notes, ordered_at) 
                      VALUES ($user_id, $address_id, 'pending', $total, '$notes', NOW())";
        if (mysqli_query($conn, $order_sql)) {
            ...
            // Save payment
            $pay_sql = "INSERT INTO payments (order_id, method, status, amount, paid_at) 
                        VALUES ($order_id, '$payment_method', 'pending', $total, NULL)";
            ...
            header("Refresh: 3; URL=index.php?order_success=$order_id");
        } else {
...
<head>
    ...
    <title>Checkout - BabyBliss</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        input[type="text"], input[type="email"], input[type="tel"], select, textarea {
            ...
            border: 2px solid #F0E4DC; border-radius: 12px;
        ...
        <?php if ($success): ?>
            <div class="success-overlay">
                <div class="success-modal">
                    ...
                    <p class="success-text">Thank you for your purchase. We're preparing your order.</p>
        ...
        <form method="POST" action="checkout.php">
            ...
            <div class="form-section">
                ...
                <div class="form-group full">
                    ...
                    <input type="text" name="street" placeholder="123 Blossom Lane" required/>
                </div>
                <div class="form-row">
                    <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="postal_code" placeholder="94105"/>
                </div>
                <div class="form-group full">
    ...
    <div class="order-summary">
        ...
        <div class="summary-item">
            <div class="item-image">
                ...
                $img = $item['image'];
                if (isImagePath($img)) {
                    echo '<img src="' . htmlspecialchars($img) . '" alt="' . htmlspecialchars($item['name']) . '">';
                } else {
                    echo $img;
                }
                ?>
